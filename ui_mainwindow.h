...
public:
    ...
    void setupUi(QMainWindow *MainWindow) {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resources/images/appicon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/resources/images/upload.png"), QSize(), QIcon::Normal, QIcon::Off);
        uploadconfirm->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/resources/images/openfile.png"), QSize(), QIcon::Normal, QIcon::Off);
        up_selectpath->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/resources/images/download.png"), QSize(), QIcon::Normal, QIcon::Off);
        downloadconfirm->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/resources/images/clear.png"), QSize(), QIcon::Normal, QIcon::Off);
        Clear->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/resources/images/save.png"), QSize(), QIcon::Normal, QIcon::Off);
        Save->setIcon(icon5);
    ...
    void retranslateUi(QMainWindow *MainWindow) {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "TFTP Client", nullptr));
        ...
        up_LocalFileName->setPlaceholderText(
                QCoreApplication::translate("MainWindow", "Input  Local  FileName", nullptr));
        ...
        down_LocalFilePath->setPlaceholderText(
                QCoreApplication::translate("MainWindow", "Input  Local   FilePath", nullptr));
        ...
        down_Server_FileName->setPlaceholderText(
                QCoreApplication::translate("MainWindow", "Input  Server  FileName", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(Download),
